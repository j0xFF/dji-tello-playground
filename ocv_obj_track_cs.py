...
leb = Tello()
leb.connect()
leb.for_back_velocity = 0
leb.left_right_velocity = 0
leb.up_down_velocity = 0
leb.yaw_velocity = 0
leb.speed = 0
...
cv2.createTrackbar("VALUE Min", "HSV", 189, 255, empty)
...
while True:
    ...
    if leb.send_rc_control:
        leb.send_rc_control(leb.left_right_velocity, leb.for_back_velocity, leb.up_down_velocity, leb.yaw_velocity)
    print(dir)
